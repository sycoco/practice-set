...
angular.module('ccms.projectRouter', ['ui.router', 'ct.ui.router.extras', 'oc.lazyLoad']).provider('$project', ['$futureStateProvider', function $ProjectProvider($futureStateProvider) {
	var _this = this;
